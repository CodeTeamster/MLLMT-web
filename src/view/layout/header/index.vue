<template>
  <div
    class="header-root flex justify-between fixed top-0 left-0 right-0 z-10 h-14 bg-white text-slate-700 dark:text-slate-300 dark:bg-slate-900 items-center px-4"
  >
    <div class="flex items-center cursor-pointer flex-1 min-w-0">
      ...
      >
        ...
        <div
          v-if="!isMobile"
          class="inline-flex font-bold text-lg ml-2 tracking-wide"
          :class="
    ...
    <div class="ml-3 flex items-center gap-2">
      ...
      <el-dropdown>
        <div class="flex justify-center items-center h-full w-full">
          <span
            class="cursor-pointer flex justify-center items-center text-slate-700 dark:text-gray-100"
          >
            <CustomPic />
